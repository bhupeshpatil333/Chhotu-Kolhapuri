<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Chhotu.Admin.Product" %>
                                        ...
                                        <div class="row">
                                            ...
                                            <div>
                                                ...
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                                    ErrorMessage="Price must in decimal" ForeColor="Red" Display="Dynamic"
                                            ...
                                            <div>
                                                ...
                                                <asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-control" 
                                                    DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="CategoryId" Width="136px" 
                                                             ...
                                                             <ItemTemplate>
                                                                 <tr>
                                                                     ...
                                                                     <td>
                                                                         ...
                                                                         <asp:Label ID="lblQuantity" runat="server" ForeColor="black" Font-Bold="true" Font-Size="Medium" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                                    ...
                                                                    <%-- <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>--%>
                                                                     ...
                                                                     <td>
                                                                         ...
                                                                         <asp:Label ID="lblIsActive" runat="server" ForeColor="White" Font-Bold="true"  Text='<%# Eval("IsActive") %>'></asp:Label>
